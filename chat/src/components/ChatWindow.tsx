...
import type { Message, ModelEndpoint, FileDiffs } from "../types/chat";
      ...
      <div className="flex-1 overflow-y-auto px-6 py-8">
        <div className="h-full flex flex-col items-center justify-center max-w-2xl mx-auto text-center space-y-8 mt-12">
          <div className="space-y-3">
            <div className="h-14 w-14 rounded-2xl bg-gradient-to-tr from-primary to-primary/70 flex items-center justify-center mx-auto shadow-xl shadow-primary/10">
              <Sparkles className="h-7 w-7 text-primary-foreground" />
            </div>
            <h2 className="text-2xl font-bold tracking-tight text-primary-foreground mt-4">
          ...
          <div className="grid grid-cols-2 gap-4 w-full text-left">
            ...
            <button
              ...
              className="p-4 rounded-xl border border-border bg-card/50 hover:bg-muted hover:border-primary/30 transition-all text-left space-y-1.5"
            >
              <div className="flex items-center gap-2 text-xs font-semibold text-primary">
                <MessageSquare className="h-3.5 w-3.5" />
                Text Chat (Ollama)
              </div>
              <p className="text-xs text-muted-foreground">"Why is the sky blue? Explain simply..."</p>
            </button>
            ...
            >
              ...
              <p className="text-xs text-muted-foreground">"A beautiful cyberpunk city skyline at night..."</p>
            </button>
            ...
            >
              ...
              <p className="text-xs text-muted-foreground">"Add a neon red sunset glow to the skyline..."</p>
            </button>
            ...
            >
              ...
              <p className="text-xs text-muted-foreground">"A camera flying through a vibrant forest..."</p>
            </button>
